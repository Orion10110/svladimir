<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1479712763,
    'editedby' => 1,
    'editedon' => 1480061226,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1479714420,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
            ...
            [[!getResources?
             ...
             <div class="well sidebar-nav">
              ...
              <li  class="nav-header"> Обзор интерьера Владимирской Церкви</li> 
                    ...
                    <div class="col-md-9">
                        <div class="row-fluid">
                           <div><ol class="breadcrumb"><li><a href="http://svladimir/">Главная</a></li><li class="active">Фотогалерея</li> </ol></div>
<h2>Фотогалерея Владимирской Церкви</h2>
                          
                        <div> [[!getPage@articlePaging?
...
<script type="text/javascript">
  ...
  <link rel="stylesheet" href="assets/css/font-awesome.min.css">',
    ...
    ]]' => '<ol class="breadcrumb"><li><a href="http://svladimir/">Главная</a></li><li class="active">Фотогалерея</li> </ol>',
    '[[$bread]]' => '<ol class="breadcrumb"><li><a href="http://svladimir/">Главная</a></li><li class="active">Фотогалерея</li> </ol>',
    '[[*longtitle]]' => 'Фотогалерея Владимирской Церкви',
    '[[$page_title]]' => '<div><ol class="breadcrumb"><li><a href="http://svladimir/">Главная</a></li><li class="active">Фотогалерея</li> </ol></div>
<h2>Фотогалерея Владимирской Церкви</h2>',
    '[[*id]]' => 8,
    '[[$footer]]' => '<footer>
    <div class="centre-margin">
...
<script type="text/javascript">
    ...
    '[[~125]]' => 'fotogalereya-vladimirskoj-czerkvi/rozhdestvenskij-utrennik.html',
    '[[~124]]' => 'fotogalereya-vladimirskoj-czerkvi/radost-v-detskom-priyute-v-d.lojki.html',
    '[[~123]]' => 'fotogalereya-vladimirskoj-czerkvi/patrebnyiya-pashtoўki-noyabr-dekabr-2013g.html',
    '[[~122]]' => 'fotogalereya-vladimirskoj-czerkvi/palomnicheskaya-poezdka-v-poloczk.html',
    '[[~121]]' => 'fotogalereya-vladimirskoj-czerkvi/solnechnyij-dom-v-priyute-d.lojki.html',
    '[[~120]]' => 'fotogalereya-vladimirskoj-czerkvi/krestnyij-xod-v-chest-ikonyi-bozhiej-materi-avgustovskaya-pobeda.html',
    '[[~119]]' => 'fotogalereya-vladimirskoj-czerkvi/progulka-v-lesu.html',
    '[[~118]]' => 'fotogalereya-vladimirskoj-czerkvi/priyut-v-d.lojki.-06-iyulya-2013-g.html',
    '[[~117]]' => 'fotogalereya-vladimirskoj-czerkvi/pasxalnaya-radost-v-priyute-v-d.lojki.html',
    '[[~116]]' => 'fotogalereya-vladimirskoj-czerkvi/pasxa-2013.-strastnaya-pyatnicza.html',
    '[[~114]]' => 'fotogalereya-vladimirskoj-czerkvi/bozhestvennaya-liturgiya-na-blagoveshhenie.html',
    '[[~113]]' => 'fotogalereya-vladimirskoj-czerkvi/gost-iz-drezdena.html',
    '[[~112]]' => 'fotogalereya-vladimirskoj-czerkvi/maslenicza-2013.html',
    '[[~111]]' => 'fotogalereya-vladimirskoj-czerkvi/i-snova-myi-v-derevne-lojki!.html',
    '[[$?namespace=``&limit=`15`&offset=`0`&page=`1`&pageVarKey=`page`&totalVar=`total`&pageLimit=`5`&elementClass=`modSnippet`&pageNavVar=`page.nav`&pageNavTpl=`<li[[+classes]]><a[[+classes]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageNavOuterTpl=`[[+prev]][[+pages]][[+next]]`&pageActiveTpl=`<li class="active"><a href="[[+href]]">[[+pageNo]]</a></li>`&pageFirstTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">Первая</a></li>`&pageLastTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">Последняя</a></li>`&pagePrevTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;&lt;</a></li>`&pageNextTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;&gt;</a></li>`&cache=``&cache_key=`resource`&cache_handler=`xPDOFileCache`&cache_expires=`0`&pageNavScheme=``&element=`getResources`&showHidden=`1`&tpl=`gallery_gertes`&sortby=`{"publishedon":"DESC"}`&includeContent=`1`&includeTVs=`1`&processTVs=`1`&tvPrefix=``&parents=`8`&hideContainers=`1`&total=`55`&pageOneLimit=`15`&actualLimit=`15`&toPlaceholder=``&qs=`fbfa714c80775c7d3998a3bb6002bcac`&pageCount=`4`&href=`fotogalereya-vladimirskoj-czerkvi/`&pageNo=`1`]]' => '<li class="active"><a href="fotogalereya-vladimirskoj-czerkvi/">1</a></li>',
    '[[$?namespace=``&limit=`15`&offset=`0`&page=`1`&pageVarKey=`page`&totalVar=`total`&pageLimit=`5`&elementClass=`modSnippet`&pageNavVar=`page.nav`&pageNavTpl=`<li[[+classes]]><a[[+classes]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageNavOuterTpl=`[[+prev]][[+pages]][[+next]]`&pageActiveTpl=`<li class="active"><a href="[[+href]]">[[+pageNo]]</a></li>`&pageFirstTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">Первая</a></li>`&pageLastTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">Последняя</a></li>`&pagePrevTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;&lt;</a></li>`&pageNextTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;&gt;</a></li>`&cache=``&cache_key=`resource`&cache_handler=`xPDOFileCache`&cache_expires=`0`&pageNavScheme=``&element=`getResources`&showHidden=`1`&tpl=`gallery_gertes`&sortby=`{"publishedon":"DESC"}`&includeContent=`1`&includeTVs=`1`&processTVs=`1`&tvPrefix=``&parents=`8`&hideContainers=`1`&total=`55`&pageOneLimit=`15`&actualLimit=`15`&toPlaceholder=``&qs=`69d59a2dfdee10d578c92eccca508aa1`&pageCount=`4`&href=`fotogalereya-vladimirskoj-czerkvi/?page=2`&pageNo=`2`]]' => '<li[[+classes]]><a[[+classes]][[+title]] href="fotogalereya-vladimirskoj-czerkvi/?page=2">2</a></li>',
    '[[$?namespace=``&limit=`15`&offset=`0`&page=`1`&pageVarKey=`page`&totalVar=`total`&pageLimit=`5`&elementClass=`modSnippet`&pageNavVar=`page.nav`&pageNavTpl=`<li[[+classes]]><a[[+classes]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageNavOuterTpl=`[[+prev]][[+pages]][[+next]]`&pageActiveTpl=`<li class="active"><a href="[[+href]]">[[+pageNo]]</a></li>`&pageFirstTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">Первая</a></li>`&pageLastTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">Последняя</a></li>`&pagePrevTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;&lt;</a></li>`&pageNextTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;&gt;</a></li>`&cache=``&cache_key=`resource`&cache_handler=`xPDOFileCache`&cache_expires=`0`&pageNavScheme=``&element=`getResources`&showHidden=`1`&tpl=`gallery_gertes`&sortby=`{"publishedon":"DESC"}`&includeContent=`1`&includeTVs=`1`&processTVs=`1`&tvPrefix=``&parents=`8`&hideContainers=`1`&total=`55`&pageOneLimit=`15`&actualLimit=`15`&toPlaceholder=``&qs=`ae742263494bff292b0db22369f0b0f2`&pageCount=`4`&href=`fotogalereya-vladimirskoj-czerkvi/?page=3`&pageNo=`3`]]' => '<li[[+classes]]><a[[+classes]][[+title]] href="fotogalereya-vladimirskoj-czerkvi/?page=3">3</a></li>',
    '[[$?namespace=``&limit=`15`&offset=`0`&page=`1`&pageVarKey=`page`&totalVar=`total`&pageLimit=`5`&elementClass=`modSnippet`&pageNavVar=`page.nav`&pageNavTpl=`<li[[+classes]]><a[[+classes]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageNavOuterTpl=`[[+prev]][[+pages]][[+next]]`&pageActiveTpl=`<li class="active"><a href="[[+href]]">[[+pageNo]]</a></li>`&pageFirstTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">Первая</a></li>`&pageLastTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">Последняя</a></li>`&pagePrevTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;&lt;</a></li>`&pageNextTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;&gt;</a></li>`&cache=``&cache_key=`resource`&cache_handler=`xPDOFileCache`&cache_expires=`0`&pageNavScheme=``&element=`getResources`&showHidden=`1`&tpl=`gallery_gertes`&sortby=`{"publishedon":"DESC"}`&includeContent=`1`&includeTVs=`1`&processTVs=`1`&tvPrefix=``&parents=`8`&hideContainers=`1`&total=`55`&pageOneLimit=`15`&actualLimit=`15`&toPlaceholder=``&qs=`0abb6528cdad51283825b90c29ef6458`&pageCount=`4`&href=`fotogalereya-vladimirskoj-czerkvi/?page=4`&pageNo=`4`]]' => '<li[[+classes]]><a[[+classes]][[+title]] href="fotogalereya-vladimirskoj-czerkvi/?page=4">4</a></li>',
    '[[$?namespace=``&limit=`15`&offset=`0`&page=`1`&pageVarKey=`page`&totalVar=`total`&pageLimit=`5`&elementClass=`modSnippet`&pageNavVar=`page.nav`&pageNavTpl=`<li[[+classes]]><a[[+classes]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageNavOuterTpl=`[[+prev]][[+pages]][[+next]]`&pageActiveTpl=`<li class="active"><a href="[[+href]]">[[+pageNo]]</a></li>`&pageFirstTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">Первая</a></li>`&pageLastTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">Последняя</a></li>`&pagePrevTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;&lt;</a></li>`&pageNextTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;&gt;</a></li>`&cache=``&cache_key=`resource`&cache_handler=`xPDOFileCache`&cache_expires=`0`&pageNavScheme=``&element=`getResources`&showHidden=`1`&tpl=`gallery_gertes`&sortby=`{"publishedon":"DESC"}`&includeContent=`1`&includeTVs=`1`&processTVs=`1`&tvPrefix=``&parents=`8`&hideContainers=`1`&total=`55`&pageOneLimit=`15`&actualLimit=`15`&toPlaceholder=``&qs=`0c18ab322ca5e12dcbd5f69f8944ac9e`&pageCount=`4`&href=`fotogalereya-vladimirskoj-czerkvi/?page=2`&pageNo=`2`]]' => '<li class="control"><a[[+classes]][[+title]] href="fotogalereya-vladimirskoj-czerkvi/?page=2">&gt;&gt;</a></li>',
    '[[$?namespace=``&limit=`15`&offset=`0`&page=`1`&pageVarKey=`page`&totalVar=`total`&pageLimit=`5`&elementClass=`modSnippet`&pageNavVar=`page.nav`&pageNavTpl=`<li[[+classes]]><a[[+classes]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageNavOuterTpl=`[[+prev]][[+pages]][[+next]]`&pageActiveTpl=`<li class="active"><a href="[[+href]]">[[+pageNo]]</a></li>`&pageFirstTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">Первая</a></li>`&pageLastTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">Последняя</a></li>`&pagePrevTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;&lt;</a></li>`&pageNextTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;&gt;</a></li>`&cache=``&cache_key=`resource`&cache_handler=`xPDOFileCache`&cache_expires=`0`&pageNavScheme=``&element=`getResources`&showHidden=`1`&tpl=`gallery_gertes`&sortby=`{"publishedon":"DESC"}`&includeContent=`1`&includeTVs=`1`&processTVs=`1`&tvPrefix=``&parents=`8`&hideContainers=`1`&total=`55`&pageOneLimit=`15`&actualLimit=`15`&toPlaceholder=``&qs=`b9f525ca486c09dfc489aa266ce2df0c`&pageCount=`4`&href=`fotogalereya-vladimirskoj-czerkvi/?page=4`&pageNo=`4`]]' => '<li class="control"><a[[+classes]][[+title]] href="fotogalereya-vladimirskoj-czerkvi/?page=4">Последняя</a></li>',
    '[[$?namespace=``&limit=`15`&offset=`0`&page=`1`&pageVarKey=`page`&totalVar=`total`&pageLimit=`5`&elementClass=`modSnippet`&pageNavVar=`page.nav`&pageNavTpl=`<li[[+classes]]><a[[+classes]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageNavOuterTpl=`[[+prev]][[+pages]][[+next]]`&pageActiveTpl=`<li class="active"><a href="[[+href]]">[[+pageNo]]</a></li>`&pageFirstTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">Первая</a></li>`&pageLastTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">Последняя</a></li>`&pagePrevTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;&lt;</a></li>`&pageNextTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;&gt;</a></li>`&cache=``&cache_key=`resource`&cache_handler=`xPDOFileCache`&cache_expires=`0`&pageNavScheme=``&element=`getResources`&showHidden=`1`&tpl=`gallery_gertes`&sortby=`{"publishedon":"DESC"}`&includeContent=`1`&includeTVs=`1`&processTVs=`1`&tvPrefix=``&parents=`8`&hideContainers=`1`&total=`55`&pageOneLimit=`15`&actualLimit=`15`&toPlaceholder=``&qs=`75322f562fe709e33b92df2e14c92ade`&pageCount=`4`&pages=`<li class="active"><a href="fotogalereya-vladimirskoj-czerkvi/">1</a></li>
<li[[+classes]]><a[[+classes]][[+title]] href="fotogalereya-vladimirskoj-czerkvi/?page=2">2</a></li>
<li[[+classes]]><a[[+classes]][[+title]] href="fotogalereya-vladimirskoj-czerkvi/?page=3">3</a></li>
<li[[+classes]]><a[[+classes]][[+title]] href="fotogalereya-vladimirskoj-czerkvi/?page=4">4</a></li>`&next=`<li class="control"><a[[+classes]][[+title]] href="fotogalereya-vladimirskoj-czerkvi/?page=2">&gt;&gt;</a></li>`&last=`<li class="control"><a[[+classes]][[+title]] href="fotogalereya-vladimirskoj-czerkvi/?page=4">Последняя</a></li>`]]' => '[[+prev]]<li class="active"><a href="fotogalereya-vladimirskoj-czerkvi/">1</a></li>
<li[[+classes]]><a[[+classes]][[+title]] href="fotogalereya-vladimirskoj-czerkvi/?page=2">2</a></li>
<li[[+classes]]><a[[+classes]][[+title]] href="fotogalereya-vladimirskoj-czerkvi/?page=3">3</a></li>
<li[[+classes]]><a[[+classes]][[+title]] href="fotogalereya-vladimirskoj-czerkvi/?page=4">4</a></li><li class="control"><a[[+classes]][[+title]] href="fotogalereya-vladimirskoj-czerkvi/?page=2">&gt;&gt;</a></li>',
  ),
  'sourceCache' => 
  array (
    'modChunk' => 
